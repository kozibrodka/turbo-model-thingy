...
public class TransformGroupBone extends TransformGroup {
    ...
    public Vec3d getBaseVector() {
        return Vec3d.createVectorHelper(this.baseVector.x, this.baseVector.y, this.baseVector.z);
    }
    ...
    public Vec3d doTransformation(PositionTransformVertex vertex) {
        Vec3d vector = Vec3d.createVectorHelper(vertex.neutralVector.x, vertex.neutralVector.y, vertex.neutralVector.z);
