...
public class ModelBox {
    ...
    public ModelBox(ModelRenderer var1, int var2, int var3, float var4, float var5, float var6, int var7, int var8, int var9, float var10) {
        ...
        Vertex var23 = new Vertex(var4, var5, var6, 0.0F, 0.0F);
        Vertex var15 = new Vertex(var11, var5, var6, 0.0F, 8.0F);
        Vertex var16 = new Vertex(var11, var12, var6, 8.0F, 8.0F);
        Vertex var17 = new Vertex(var4, var12, var6, 8.0F, 0.0F);
        Vertex var18 = new Vertex(var4, var5, var13, 0.0F, 0.0F);
        Vertex var19 = new Vertex(var11, var5, var13, 0.0F, 8.0F);
        Vertex var20 = new Vertex(var11, var12, var13, 8.0F, 8.0F);
        Vertex var21 = new Vertex(var4, var12, var13, 8.0F, 0.0F);
        ...
        this.quadList[0] = new Quad(new Vertex[]{var19, var15, var16, var20}, var2 + var9 + var7, var3 + var9, var2 + var9 + var7 + var9, var3 + var9 + var8);
        this.quadList[1] = new Quad(new Vertex[]{var23, var18, var21, var17}, var2, var3 + var9, var2 + var9, var3 + var9 + var8);
        this.quadList[2] = new Quad(new Vertex[]{var19, var18, var23, var15}, var2 + var9, var3, var2 + var9 + var7, var3 + var9);
        this.quadList[3] = new Quad(new Vertex[]{var16, var17, var21, var20}, var2 + var9 + var7, var3 + var9, var2 + var9 + var7 + var7, var3);
        this.quadList[4] = new Quad(new Vertex[]{var15, var23, var17, var16}, var2 + var9, var3 + var9, var2 + var9 + var7, var3 + var9 + var8);
        this.quadList[5] = new Quad(new Vertex[]{var18, var19, var20, var21}, var2 + var9 + var7 + var9, var3 + var9, var2 + var9 + var7 + var9 + var7, var3 + var9 + var8);
...
//        this.quadList[5] = new TexturedQuadAlt(new QuadPoint[]{var18, var19, var20, var21}, var2 + var9 + var7 + var9, var3 + var9, var2 + var9 + var7 + var9 + var7, var3 + var9 + var8, var1.textureWidth, var1.textureHeight);
    ...
    public void render(Tessellator var1, float var2) {
        for(int var3 = 0; var3 < this.quadList.length; ++var3) {
            this.quadList[var3].render(var1, var2);
        }
